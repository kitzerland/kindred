<div class="row">
	<div class="col-md-8">
		<div class="card">
            ...
            <div class="content">
                <form action="<?php echo base_url('/doctor_registration'); ?>" method="POST">
                	<div class="row">
                		<div class="col-md-6">
                            <div class="form-group">
                                <label>Doctor Registration Number</label>
                                <input type="text" class="form-control" name="registration_number" placeholder="Doctor registration number">
                            </div>
                        </div>
                	</div>
    				<div class="row">
